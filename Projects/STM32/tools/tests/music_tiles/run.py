...
for data_debug,opt in ((0,'-O0'),(0,'-Os'),(0,'-Oz')):
    ...
    def call(name):
        uc.reg_write(UC_ARM_REG_LR,0x1007fff1);uc.emu_start(syms[name]|1,0x1007fff0,count=900000000)
