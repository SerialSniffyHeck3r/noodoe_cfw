...
/* Project configuration adapter derived from pinned LVGL/ChaN header.
 * Original vendor files are untouched. Pre-including this header supplies the
 * same JDEC ABI with basic decoding and RGB565; tjpgd.c's DEF_TJPGDEC guard
 * prevents its default configuration from replacing these values. */
