...
![내 AK550과 Noodoe](Projects/documentations/images/my-ak550.jpg)

**킴코 모터사이클에 장착된 순정 옵션 "Noodoe" 에 새 생명을 불어넣는 커스텀 펌웨어 프로젝트입니다.**


![속도 링과 트립 컴퓨터](Projects/Manuals/images/trip-a.png)
...
[English](README.md) · [최신 APK](https://github.com/SerialSniffyHeck3r/noodoe_cfw/releases/latest/download/NoodoeCompanion-6.11.4.apk) · [설치 ZIP](https://github.com/SerialSniffyHeck3r/noodoe_cfw/releases/latest/download/NoodoeInstaller-CFW-6.11.4.zip) · [릴리스 설명](https://github.com/SerialSniffyHeck3r/noodoe_cfw/releases/latest)
